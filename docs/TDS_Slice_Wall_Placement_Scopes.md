...
**Status:** **PHASES 1–4 BUILT** 2026-08-23 (schema, Worker API, the pure layer, the chore UI).
Phases 5–6 unbuilt: the block sheet (§6.2), the add-for-today sheet (§6.3), the creation default
(§6.4), and Phase 6's manual checks and doc reconciliation. `CLAUDE.md` still records this slice as
"authorized, unbuilt" and stays that way until Phase 6 (§10).

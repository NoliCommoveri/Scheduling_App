...
**Status:** **PHASES 1–4 AND 5a BUILT** 2026-08-23 (schema, Worker API, the pure layer, the chore
UI, and the block write paths). Phase 5b is the block *sheets* — §6.2's schedule sheet and §6.3's
add-for-today sheet — and Phase 6 is the manual checks and doc reconciliation. `CLAUDE.md` still
records this slice as "authorized, unbuilt" and stays that way until Phase 6 (§10).
...
| **5b** | Block sheets: §6.2's schedule sheet including the Today group, §6.3's add-for-today sheet. | ~1.5 h |
